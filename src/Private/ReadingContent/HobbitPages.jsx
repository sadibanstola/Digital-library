...
const HobbitPages = [
  ...
  (goToPreviousPage, goToNextPage, setPageIndex, exit) => (
    <div className="w-screen h-screen bg-gray-600 relative overflow-hidden">
      <motion.img
        src="/hobbit1.png"
  ...
  // Page 2
  (goToPreviousPage, goToNextPage, setPageIndex, exit) => (
    <div className="w-screen h-screen bg-[#3E2640] text-white relative overflow-hidden" style={{ fontFamily: '"Gothic A1", sans-serif' }}>
  ...
  // Page 3
  (goToPreviousPage, goToNextPage, setPageIndex, exit) => (
    <div className="w-screen h-screen bg-[#FAF8F3] text-black relative overflow-hidden" style={{ fontFamily: '"Gothic A1", sans-serif' }}>
      {/* Navigation arrows */}
      <button
        onClick={goToPreviousPage}
  ...
  // Page 4
  (goToPreviousPage, goToNextPage, setPageIndex, exit) => (
    <div className="w-screen h-full bg-[#3E2640] text-white relative overflow-hidden" style={{ fontFamily: '"Gothic A1", sans-serif' }}>
      {/* Navigation arrows */}
      <button
        onClick={goToPreviousPage}
        className="absolute top-4 left-4 bg-transparent border-none cursor-pointer z-10 text-white text-3xl"
      ...
      <div className="flex flex-col h-full pt-16" style={{ fontFamily: '"Gothic A1", sans-serif' }}>
        ...
        <div className="pl-24 space-y-4 text-xl font-normal">
          ...
          <div>CHAPTER IX: BARRELS OUT OF BOND</div>
