...
const WhyChooseUs = () => {
  return (
    <>
      ...
      <section className="py-[60px] px-4 lg:px-[100px] bg-[#E6F0FA] text-center h-auto lg:h-[680px]">
        <h2 className="font-marion-fallback text-2xl lg:text-[36px] text-[#121212] mb-[40px]">
          Why Choose LibraDream?
        </h2>
        <div className="flex flex-col lg:flex-row justify-center gap-[30px] flex-wrap">
          {/* Card 1: Curated Content */}
          <div className="max-w-[350px] w-full p-[20px] bg-white rounded-[10px] shadow-[0_2px_10px_rgba(0,0,0,0.1)] hover:bg-[#E5E5E5] transition-colors duration-300 group">
            <img
              src="/1.png"
              alt="Curated Content"
              className="w-full h-auto mb-[15px] transform group-hover:scale-90 transition-transform duration-300"
            />
            <h3 className="font-['Gothic_A1'] font-medium text-lg lg:text-[20px] text-[#5352ED] mb-[10px] text-left">
              Curated Content
            </h3>
            <p className="font-['Gothic_A1'] font-light text-sm lg:text-[16px] text-[#121212CC] leading-[1.5] text-left">
